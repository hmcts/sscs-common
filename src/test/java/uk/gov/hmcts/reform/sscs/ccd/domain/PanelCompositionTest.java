...
public class PanelCompositionTest {
    ...
    @Parameters({
        ...
        "IBC_PANEL_COMPOSITION, judge and if applicable a medical member and/or a financially qualified tribunal member, barnwr ac os yw’n berthnasol\\, aelod meddygol ac/neu aelod tribiwnlys cymwys"}
    )
