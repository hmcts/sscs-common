...
public class EventTypeTest {
    ...
    public void eventNameIsCorrect() {
        List<EventType> exceptions = Arrays.asList(DWP_RESPOND, ADJOURNED,
            ...
            SOR_ISSUE_DIRECTIONS, SOR_REFUSED,SOR_WRITE, REQUEST_CORRECTION, REQUEST_LIBERTY_APPLY,
            REQUEST_PERMISSION_APPEAL, REQUEST_POST_HEARING, REQUEST_SET_ASIDE, REQUEST_SOR);
