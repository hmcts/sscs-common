...
public class SscsCaseDataTest {
    ...
    public void sortHearingsByIdFirstThenDate() {
        List<Hearing> hearings = new ArrayList();
        Hearing hearing1 = Hearing.builder().value(HearingDetails.builder().hearingId("1").hearingDate("2019-04-01").time("12:00").build()).build();
        Hearing hearing2 = Hearing.builder().value(HearingDetails.builder().hearingId("2").hearingDate("2019-03-01").time("12:00").build()).build();
        Hearing hearing3 = Hearing.builder().value(HearingDetails.builder().hearingId("2").hearingDate("2019-02-01").time("12:00").build()).build();
        hearings.add(hearing1);
        hearings.add(hearing2);
        hearings.add(hearing3);
        ...
        assertEquals("2019-02-01", sscsCaseData.getHearings().get(1).getValue().getHearingDate());
        assertEquals("2", sscsCaseData.getHearings().get(1).getValue().getHearingId());
        assertEquals("2019-04-01", sscsCaseData.getHearings().get(2).getValue().getHearingDate());
        assertEquals("1", sscsCaseData.getHearings().get(2).getValue().getHearingId());
    }
    ...
    public void sortHearingsByIdWhenFewHearingsHaveBlankId() {
        ...
        assertEquals("2019-05-01", sscsCaseData.getHearings().get(0).getValue().getHearingDate());
        assertNull(sscsCaseData.getHearings().get(0).getValue().getHearingId());
        assertEquals("2019-04-01", sscsCaseData.getHearings().get(1).getValue().getHearingDate());
