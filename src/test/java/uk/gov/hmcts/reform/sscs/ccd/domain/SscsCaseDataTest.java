...
public class SscsCaseDataTest {
    ...
    @Test
    public void sortHearingsByDateFirstThenId() {
        List<Hearing> hearings = new ArrayList<>();
        ...
        assertEquals("2019-04-01", sscsCaseData.getHearings().get(0).getValue().getHearingDate());
        assertEquals("2", sscsCaseData.getHearings().get(0).getValue().getHearingId());
        assertEquals("2019-03-01", sscsCaseData.getHearings().get(1).getValue().getHearingDate());
        ...
        assertEquals("20", sscsCaseData.getHearings().get(2).getValue().getHearingId());
        assertEquals("2019-02-01", sscsCaseData.getHearings().get(3).getValue().getHearingDate());
        assertEquals("3", sscsCaseData.getHearings().get(3).getValue().getHearingId());
    ...
    public void sortHearingsByIdWhenFewHearingsHaveBlankId() {
        List<Hearing> hearings = new ArrayList<>();
        Hearing hearing1 = Hearing.builder().value(HearingDetails.builder().hearingDate("2019-02-01").time("12:00").build()).build();
        Hearing hearing2 = Hearing.builder().value(HearingDetails.builder().hearingDate("2019-04-01").time("12:00").build()).build();
        ...
        assertEquals("2019-04-01", sscsCaseData.getHearings().get(0).getValue().getHearingDate());
        assertNull(sscsCaseData.getHearings().get(0).getValue().getHearingId());
        assertEquals("2019-02-01", sscsCaseData.getHearings().get(1).getValue().getHearingDate());
        assertEquals("1", sscsCaseData.getHearings().get(1).getValue().getHearingId());
        assertEquals("2019-02-01", sscsCaseData.getHearings().get(2).getValue().getHearingDate());
