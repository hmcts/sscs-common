...
public enum AdminCorrectionType implements CcdCallbackMap {
    BODY("bodyCorrection", "Body correction - Send to judge", EventType.ADMIN_CORRECTION_BODY, "Admin correction body", "Admin correction body", null, InterlocReviewState.REVIEW_BY_JUDGE, InterlocReferralReason.REVIEW_CORRECTION_REQUEST),
