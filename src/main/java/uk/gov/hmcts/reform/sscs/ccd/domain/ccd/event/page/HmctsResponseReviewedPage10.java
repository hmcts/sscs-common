...
import uk.gov.hmcts.reform.sscs.ccd.domain.DwpResponseDocumentCT;
...
public final class HmctsResponseReviewedPage10 {
    ...
    public static void apply(
        ...
        fields.complex(SscsCaseData::getDwpResponseDocument)
                    .optional(DwpResponseDocumentCT::getDwpResponseDocumentTitle)
                    ...
                    .pageId("1.0")
                    .optional(DwpResponseDocumentCT::getHmrcResponseDocumentTitle)
                    ...
                    .pageId("1.0")
                    .optional(DwpResponseDocumentCT::getIbcaResponseDocumentTitle)
                    .fieldShowCondition("appeal.benefitType.code=\"infectedBloodCompensation\"")
                    .pageId("1.0")
                    .readonly(DwpResponseDocumentCT::getDocumentFileName)
                    .pageId("1.0")
                    .readonly(DwpResponseDocumentCT::getDocumentLink)
                    .noHintText()
                    .pageId("1.0").done();
