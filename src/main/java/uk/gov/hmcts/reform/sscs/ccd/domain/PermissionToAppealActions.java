...
public enum PermissionToAppealActions implements CcdCallbackMap {
    ...
    REVIEW("review", "Review and Set Aside Application", REVIEW_AND_SET_ASIDE, "Permission to Appeal Decision Remade", "Permission to Appeal Decision Remade", DwpState.DECISION_REMADE, InterlocReviewState.NONE);
