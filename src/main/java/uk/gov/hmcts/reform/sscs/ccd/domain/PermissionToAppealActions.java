...
public enum PermissionToAppealActions implements CcdCallbackMap {
    ...
    REVIEW("review", "Review granted", REVIEW_AND_SET_ASIDE, "Permission to Appeal Decision Remade", "Permission to Appeal Review granted", DwpState.DECISION_REMADE, InterlocReviewState.REVIEW_BY_JUDGE);
