...
public final class DwpUploadResponsePage10 {
    ...
    public static void apply(
        ...
        fields.complex(SscsCaseData::getDwpResponseDocument)
                    ...
                    .pageId("1.0")
                    .mandatory(DwpResponseDocumentCT::getDocumentFileName)
                    .pageId("1.0")
                    .mandatory(DwpResponseDocumentCT::getDocumentLink)
                    .noHintText()
                    .pageId("1.0").done();
