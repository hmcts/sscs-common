...
public enum EventType {
    ...
    ACTION_POST_HEARING_APPLICATION("actionPostHearingApplication", 0, false),
    ...
    REQUEST_CORRECTION("correctionRequested", 0, false),
    REQUEST_LIBERTY_APPLY("libertyToApplyRequest", 0, false),
    REQUEST_PERMISSION_APPEAL("permissionToAppealRequest", 0, false),
    REQUEST_POST_HEARING("requestPostHearing", 0, false),
    REQUEST_SET_ASIDE("setAsideRequest", 0, false),
    REQUEST_SOR("sORRequest", 0, false),
    ...
    SET_ASIDE_ISSUE_DIRECTIONS("setAsideIssueDirections", 0, true),
