...
public enum EventType {
    ...
    LETTER_NOTIFICATION_SENT("letterNotificationSent", 0, false),
    EMAIL_NOTIFICATION_SENT("emailNotificationSent", 0, false),
    SMS_NOTIFICATION_SENT("smsNotificationSent", 0, false),
