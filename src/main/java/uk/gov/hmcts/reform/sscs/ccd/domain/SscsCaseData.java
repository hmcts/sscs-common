...
public class SscsCaseData implements CaseData {
    ...
    private String writeFinalDecisionShowPresOfficerQuestion;
    ...
    public SscsCaseData(@JsonProperty(value = "ccdCaseId", access = JsonProperty.Access.WRITE_ONLY) String ccdCaseId,
        ...
        @JsonProperty("writeFinalDecisionShowPresOfficerQuestion") String writeFinalDecisionShowPresOfficerQuestion,
        ...
        this.writeFinalDecisionShowPresOfficerQuestion = writeFinalDecisionShowPresOfficerQuestion;
    ...
    public String getWriteFinalDecisionShowPresOfficerQuestion() {
        // Can put compilated logic in here
        return "faceToFace".equals(writeFinalDecisionTypeOfHearing)
            || "telephone".equals(writeFinalDecisionTypeOfHearing)
            || "telephone".equals(writeFinalDecisionTypeOfHearing) ? "Yes" : "No";
    }
