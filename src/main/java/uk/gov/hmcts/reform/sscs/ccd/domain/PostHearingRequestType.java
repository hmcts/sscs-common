...
public enum PostHearingRequestType implements CcdCallbackMap {
    ...
    STATEMENT_OF_REASONS("statementOfReasons","Statement of Reasons", SOR_REQUEST, "Statement of Reasons Request Made", "Statement of Reasons Request Made", null, AWAITING_ADMIN_ACTION, POST_HEARING_REQUEST),
