...
public enum PostHearingRequestType implements CcdCallbackMap {
    SET_ASIDE("setAside","Set Aside", SET_ASIDE_REQUEST, "Set Aside Request Made", "Set Aside Request Made", SET_ASIDE_REQUESTED, REVIEW_BY_JUDGE, POST_HEARING_REQUEST),
    CORRECTION("correction","Correction", CORRECTION_REQUEST, "Correction Request Made", "Correction Request Made", null, REVIEW_BY_JUDGE, POST_HEARING_REQUEST),
    STATEMENT_OF_REASONS("statementOfReasons","Statement of Reasons", SOR_REQUEST, "Statement of Reasons Request Made", "Statement of Reasons Request Made", null, REVIEW_BY_JUDGE, POST_HEARING_REQUEST),
    PERMISSION_TO_APPEAL("permissionToAppeal","Permission to Appeal", PERMISSION_TO_APPEAL_REQUEST, "Permission to Appeal Request Made", "Permission to Appeal Request Made", null, REVIEW_BY_JUDGE, POST_HEARING_REQUEST),
    LIBERTY_TO_APPLY("libertyToApply","Liberty to Apply", LIBERTY_TO_APPLY_REQUEST, "Liberty to Apply Request Made", "Liberty to Apply Request Made", null, REVIEW_BY_JUDGE, POST_HEARING_REQUEST);
