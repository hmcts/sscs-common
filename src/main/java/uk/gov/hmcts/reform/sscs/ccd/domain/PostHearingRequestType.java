...
public enum PostHearingRequestType implements CcdCallbackMap {
    ...
    PERMISSION_TO_APPEAL("permissionToAppeal","Permission to Appeal", PERMISSION_TO_APPEAL_REQUEST, "Permission to Appeal Request Made", "Permission to Appeal Request Made", null, AWAITING_ADMIN_ACTION, REVIEW_PERMISSION_TO_APPEAL_APPLICATION),
