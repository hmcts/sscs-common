...
public enum Benefit {
    ...
    INFECTED_BLOOD_APPEAL("Infected Blood Appeal", "Apêl Gwaed Heintiedig", "093", "infectedBloodAppeal", List.of("093"), false, DwpAddressLookupService::infectedBloodAppealMappings, AirLookupService::getInfectedBloodCompensationVenue, SSCS8);
