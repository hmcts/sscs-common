...
public enum Benefit {
    ...
    SOCIAL_FUND("Social Fund", "Cronfa Gymdeithasol", "088", "socialFund", List.of("088"), false, DwpAddressLookupService::socialFundOfficeMappings, AirLookupService::getJsaBereavementBenefitVenue);
    ...
    public PanelComposition getPanelComposition() {
        switch (this) {
            ...
            case CARERS_ALLOWANCE: case BEREAVEMENT_BENEFIT: case JSA: case MATERNITY_ALLOWANCE: case SOCIAL_FUND:
                return JUDGE;
            case IIDB:
