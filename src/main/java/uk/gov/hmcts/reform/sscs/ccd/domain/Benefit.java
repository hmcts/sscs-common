...
import static uk.gov.hmcts.reform.sscs.ccd.domain.SscsType.SSCS8;
...
public enum Benefit {
    ...
    INFECTED_BLOOD_APPEAL("Infected Blood Compensation", "Apêl Gwaed Heintiedig", "093", "infectedBloodAppeal", List.of("093"), false, DwpAddressLookupService::infectedBloodAppealMappings, AirLookupService::getInfectedBloodCompensationVenue, SSCS8);
