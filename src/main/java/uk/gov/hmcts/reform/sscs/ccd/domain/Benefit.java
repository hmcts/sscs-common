...
public enum Benefit {
    ...
    SOCIAL_FUND("Social Fund", "Cronfa Gymdeithasol", "066", "socialFund", List.of("066"), false, DwpAddressLookupService::socialFundOfficeMappings, AirLookupService::getJsaBereavementBenefitVenue);
