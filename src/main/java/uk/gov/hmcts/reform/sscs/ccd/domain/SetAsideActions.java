...
public enum SetAsideActions implements CcdCallbackMap {
    ...
    REFUSE_SOR("refuse","Refuse Set Aside Application", SET_ASIDE_REFUSED_SOR, "Set aside application refused & request statement of reasons", "Set aside application refused & request statement of reasons", DwpState.SET_ASIDE_REFUSED, InterlocReviewState.REVIEW_BY_JUDGE);
