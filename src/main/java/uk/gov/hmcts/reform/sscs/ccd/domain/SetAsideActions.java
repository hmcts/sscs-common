...
public enum SetAsideActions implements CcdCallbackMap {
    GRANT("grant","Grant Set Aside Application", SET_ASIDE_GRANTED, "Set aside application granted", "Set aside application granted", null, null),
    ...
    ISSUE_DIRECTIONS("issueDirections","IssueDirections", SET_ASIDE_ISSUE_DIRECTIONS, "Set aside application issue directions", "Set aside application issue directions", null, null),
    REFUSE_SOR("issueDirections","IssueDirections", SET_ASIDE_REFUSED_SOR, "Set aside application refused & request statement of reasons", "Set aside application refused & request statement of reasons", DwpState.SET_ASIDE_REFUSED, InterlocReviewState.REVIEW_BY_JUDGE);
