...
public enum LibertyToApplyActions implements CcdCallbackMap {
    GRANT("grant","Grant Liberty to Apply Application", LIBERTY_TO_APPLY_GRANTED, "Liberty to apply application granted", "Liberty to apply application granted", DwpStates.LIBERTY_TO_APPLY_GRANTED, InterlocReviewState.AWAITING_ADMIN_ACTION),
    REFUSE("refuse","Refuse Liberty to Apply Application", LIBERTY_TO_APPLY_REFUSED, "Liberty to apply application Refused", "Liberty to apply application Refused", DwpStates.LIBERTY_TO_APPLY_REFUSED, InterlocReviewState.NONE);
