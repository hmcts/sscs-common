...
public enum LibertyToApplyActions implements CcdCallbackMap {
    GRANT("grant","Grant Liberty to Apply Application", LIBERTY_TO_APPLY_GRANTED, "Liberty to apply application granted", "Liberty to apply application granted", DwpState.LIBERTY_TO_APPLY_GRANTED, null),
