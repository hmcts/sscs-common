...
public enum DocumentType {
    ...
    PERMISSION_TO_APPEAL_GRANTED("permissionToAppealGranted", "Permission to Appeal Decision Notice"),
    PERMISSION_TO_APPEAL_REFUSED("permissionToAppealRefused", "Permission to Appeal Decision Notice"),
