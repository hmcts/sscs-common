...
public enum SessionCategory {
    ...
    CATEGORY_05(5,List.of(JUDGE, SPECIALIST_DOCTOR),"Judge & Specialist Doctor"),
    CATEGORY_06(6,List.of(JUDGE, SPECIALIST_DOCTOR, SPECIALIST_DOCTOR),"Judge & Two Specialist Doctors"),
